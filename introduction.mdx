...
<Cards>
  ...
  <Card title="Examples & SDKs" icon="blocks" href="/sdks/overview">
...
- **Passwordless** — [Passkeys (FIDO2 / WebAuthn)](/authentication/passkeys) for phishing-resistant authentication
- **Multi-Factor Authentication** — OTP, U2F, OTP Email, OTP SMS
- **Enterprise & Social IdPs** — [LDAP](/authentication/ldap), SAML, OIDC providers
...
- **Triple API Access** — [connectRPC, gRPC, and REST](/api/overview) for every resource
...
<Steps>
  ...
  <Step title="Understand the Concepts">
    Read about [ZITADEL's architecture and multi-tenancy model](/concepts/architecture)
  </Step>
  <Step title="Integrate Your App">
    Explore [authentication examples](/examples/nextjs) for your framework
  </Step>
  <Step title="Deploy to Production">
    Review [production deployment guides](/deployment/kubernetes) for Kubernetes or Docker Compose
  </Step>
</Steps>

...
<Note>
This quickstart uses Docker Compose for local development. For production deployments, see [Kubernetes](/self-hosting/deploy/kubernetes) or [Docker Compose production guide](/self-hosting/deploy/compose).
</Note>
...
<Steps>
  ...
  <Step title="Create a user via API">
    ...
    <Tip>
    Explore the full API reference at [zitadel.com/docs/apis/introduction](/apis/introduction)
    </Tip>
  </Step>
</Steps>
...
<CardGroup cols={2}>
  <Card title="Integrate with Your Framework" icon="code" href="/examples">
    Ready-to-use examples for React, Next.js, Go, Python, and more
  </Card>
  <Card title="Understand Multi-Tenancy" icon="building" href="/concepts/structure">
    Learn about Instances, Organizations, and Projects
  </Card>
  <Card title="Enable Passkeys" icon="key" href="/concepts/features/passkeys">
    Add passwordless authentication to your login flow
  </Card>
  <Card title="Production Deployment" icon="server" href="/self-hosting/deploy/kubernetes">
    Deploy ZITADEL to Kubernetes for high availability
  </Card>
  <Card title="Custom Branding" icon="palette" href="/guides/manage/customize/branding">
    Customize the login UI with your brand colors and logo
  </Card>
  <Card title="API Reference" icon="book" href="/apis/introduction">
